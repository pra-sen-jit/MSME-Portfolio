        ...
        <div className="bg-white shadow overflow-hidden rounded-lg mb-4">
                ...
                {currentArtisans.length > 0 ? (
                  currentArtisans.map((artisan) => (
                    <tr key={artisan.id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{artisan.specialization}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{artisan.contact}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        <button className="text-green-600 hover:text-green-900 mr-3">☑</button>
          ...
          <div className="px-6 py-3 bg-gray-50 flex items-center justify-between">
            <div className="text-sm text-gray-500">
              Showing {indexOfFirstArtisan + 1} to {Math.min(indexOfLastArtisan, filteredArtisans.length)} of {filteredArtisans.length} artisans
            </div>
