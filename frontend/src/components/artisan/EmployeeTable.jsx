    ...
    >
      ...
      <div className="flex flex-wrap gap-10 py-3.5 pr-11 pl-4 max-w-full text-base rounded-lg border-b bg-neutral-50 border-neutral-200 text-neutral-700 w-[1332px] max-md:pr-5">
        <div className="flex flex-wrap flex-auto max-md:max-w-full">
          <div className="pt-0.5 pb-2.5 whitespace-nowrap bg-black bg-opacity-0 font-medium">
            Name
          </div>
          <div className="py-1.5 ml-20 whitespace-nowrap bg-black bg-opacity-0 font-medium">
            Specialization
          </div>
          <div className="pt-0.5 pb-2.5 ml-20 bg-black bg-opacity-0 font-medium">
            Contact Details
          </div>
        </div>
        <div className="pt-0.5 pb-2.5 whitespace-nowrap bg-black bg-opacity-0 font-medium">
      ...
      <div className="flex flex-wrap gap-10 py-3.5 pr-11 pl-4 w-full bg-black bg-opacity-0 max-md:pr-5 max-md:max-w-full">
        <div className="flex flex-wrap flex-auto max-md:max-w-full">
          ...
          <div className="py-2.5 ml-10 text-base bg-black bg-opacity-0 text-neutral-600">
            Silver Ornaments expert
          </div>
          <div className="flex gap-2 py-2 ml-10 bg-black bg-opacity-0">
        ...
        <div className="flex gap-3 py-2 pr-10 bg-black bg-opacity-0">
