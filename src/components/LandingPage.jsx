...
function LandingPage() {
  ...
  return (
    <main className="flex overflow-hidden flex-col pt-2.5 bg-white">
      <header className="flex flex-wrap px-5 justify-between items-start self-center w-full max-w-[1331px] max-md:max-w-full">
        ...
        <div className="flex gap-2">
          <img
            ...
            className="object-contain overflow-hidden shrink-0 aspect-square w-[42px] cursor-pointer"
          />
          <img
...
<button className="relative mt-14 px-8 py-4 text-xl font-semibold text-black bg-yellow-400 rounded-full shadow-md hover:bg-yellow-300 transition duration-300">
  Explore Now
</button>
